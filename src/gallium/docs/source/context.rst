...
``PIPE_QUERY_PIPELINE_STATISTICS`` returns the following values:
0x00: Number of vertices read from vertex buffers.
0x08: Number of primitives read from vertex buffers.
0x10: Number of vertex shader invocations.
0x18: Number of geometry shader invocations.
0x20: Number of primitives generated by geometry shaders.
0x28: Number of primitives forwarded to the rasterizer.
0x30: Number of primitives rasterized.
0x38: Number of fragment shader invocations.
0x40: Number of hull shader invocations.
0x48: Number of domain shader invocations.
